# inventario_v2/management/commands/reset_and_populate_v2.py
...
class Command(BaseCommand):
    help = (
        "Limpa apenas os dados do app inventario_v2 e popula com exemplos. "
        "Não altera outros apps (v3 etc.).\n"
        "Uso: python manage.py reset_and_populate_v2 [--admin USER] [--password PASS] [--email EMAIL] [--noadmin]"
    )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("-> Aplicando migrações do app inventario_v2 (migrate inventario_v2)...")
        try:
        ...
        # 4) Importar modelo Produtos do inventario_v2 e popular com amostras
        try:
