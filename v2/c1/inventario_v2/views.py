...
class ProdutosLista(LoginRequiredMixin, ListView):
    model = Produtos
    template_name = "inventario_v2/produtos_lista.html"  # corrigido (sem .html.html)
...
class ProdutosAdicionar(LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy("inventario_v2:produtos_lista")  # usa o name definido no urls.py
