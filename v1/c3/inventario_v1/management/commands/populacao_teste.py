...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # tentar obter Categoria (caso o modelo exista)
        Categoria = None
        try:
        ...
        amostras = [
            {"nome": "Parafuso M6", "descricao": "Parafuso de aço inox", "quantidade": 150, "preco": Decimal("0.15"), "categoria": "Peças"},
            {"nome": "Porca M6", "descricao": "Porca sextavada", "quantidade": 200, "preco": Decimal("0.05"), "categoria": "Peças"},
            {"nome": "Arruela M6", "descricao": "Arruela lisa", "quantidade": 300, "preco": Decimal("0.02"), "categoria": "Peças"},
            {"nome": "Cabo USB 1m", "descricao": "Cabo USB-A para USB-B", "quantidade": 50, "preco": Decimal("5.00"), "categoria": "Periféricos"},
            {"nome": 'Monitor 24"', "descricao": "Monitor LED 24\"", "quantidade": 10, "preco": Decimal("420.00"), "categoria": "Eletrônicos"},
            {"nome": "Teclado USB", "descricao": "Teclado membrana ABNT2", "quantidade": 25, "preco": Decimal("35.50"), "categoria": "Periféricos"},
            {"nome": "Mouse Óptico", "descricao": "Mouse óptico USB", "quantidade": 40, "preco": Decimal("19.90"), "categoria": "Periféricos"},
            {"nome": "Chave de Fenda", "descricao": "Chave de fenda Phillips", "quantidade": 60, "preco": Decimal("3.75"), "categoria": "Ferramentas"},
        ]
