...
def test_urls_reverse_and_resolve():
    ...
    url_list = reverse("inventario_v1:produtos_lista")
    url_add = reverse("inventario_v1:produtos_adicionar")
    ...
    assert resolved.view_name in ("inventario_v1:produtos_lista", "produtos_lista")
...
def test_produtos_update_view(client_logged_in, sample_produtos):
    ...
    url = reverse("inventario_v1:produtos_editar", args=(produto.pk,))
...
def test_produtos_delete_view(client_logged_in):
    ...
    url = reverse("inventario_v1:produtos_remover", args=(p.pk,))
